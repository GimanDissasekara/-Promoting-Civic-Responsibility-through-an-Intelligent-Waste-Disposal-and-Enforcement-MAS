...
def main():
    ...
    running = True
    step_count = 0
    auto_step = False  # Flag for automatic stepping
    ...
    while running:
        ...
        # Display arrest count
        arrest_text = font.render(f"Arrests: {simulation.arrests}", True, WHITE)
        ...
        # Control frame rate
        clock.tick(10)  # 10 FPS to make steps more visible
